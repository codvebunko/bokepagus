...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepagus.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "logo": "https://bokepagus.pages.dev/favicon.ico",
        "url": "https://bokepagus.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepagus.pages.dev"
        ...
        "url": "https://bokepagus.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa`,
        "image": "https://bokepagus.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepagus.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepagus.pages.dev/?q={search_term}", 
